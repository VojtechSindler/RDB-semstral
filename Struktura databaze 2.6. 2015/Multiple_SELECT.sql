alter VIEW Multiple_data_select
AS
...
JOIN Points ON Measurement.pointID = Points.pointID  AND Points.value1 = Measurement.value1 AND Points.value2 = Measurement.value2 JOIN Machines 
